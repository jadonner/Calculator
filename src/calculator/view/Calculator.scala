    ...
    scene = new Scene() {
      content = List(
        new GridPane {
          ...
          add(new CalculatorButton("-", new SubtractionAction(calculatorModel)), 5, 1)
          add(new CalculatorButton("+", new AdditionAction(calculatorModel), yScale = 2.0), 5, 2, 1, 2)
          add(new CalculatorButton("=", new EqualAction(calculatorModel), yScale = 2.0), 5, 4, 1, 2)
          add(new CalculatorButton("+/-", new NegateAction(calculatorModel)), 4, 1)
          add(new CalculatorButton("sin", new SinAction(calculatorModel)), 4, 2)
          add(new CalculatorButton("cos", new CosAction(calculatorModel)), 4, 3)
          add(new CalculatorButton("rad", new RadAction(calculatorModel)), 4, 4)
          add(new CalculatorButton("de", new RadAction(calculatorModel)), 4, 5)
